...
class GPT(nn.Module):
    ...
    def compute_embeddings(
        ...
        attention_mask_for_generation = torch.ones_like(gpt_inputs, dtype=torch.long)
        
        return gpt_inputs, attention_mask_for_generation
    ...
    def generate(
        ...
        **hf_generate_kwargs,
        ...
        gpt_inputs, attention_mask_for_generation = self.compute_embeddings(cond_latents, text_inputs)
