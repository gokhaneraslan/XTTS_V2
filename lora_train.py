...
def main():
    ...
    config = GPTTrainerConfig(
        ...
        run_name="xtts_finetune_tr_v2_lora",
        project_name="xtts_turkish_finetuning_project_lora",
        run_description="Fine-tuning-lora XTTS on custom Turkish LJSPEECH-like dataset",
